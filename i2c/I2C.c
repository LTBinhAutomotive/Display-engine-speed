...
*/	
	...
	temp =  I2C1->SR2;  // read SR2 to clear the ADDR bit
}
...
/**** STEP 1 ****/	
	if (size == 1)
	{
		...
		temp =I2C1->SR2;  // read SR1 and SR2 to clear the ADDR bit.... EV6 condition
		I2C1->CR1 |= (1<<9);  // Stop I2C
...
/**** STEP 2 ****/		
	else 
	{
		...
		uint32_t temp;
		/**** STEP 2-b ****/
		temp = I2C1->SR2;  // read SR1 and SR2 to clear the ADDR bit
